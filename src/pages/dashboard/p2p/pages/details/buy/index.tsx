...
import TicketGenerated from "components/modal/modals/ticket-generated";
...
const BuyDetails = () => {
  ...
  const [fundsReceieved, setFundsReceieved] = useState(false);

  const appealList = [
    "I have made payment but the seller is yet to release coin.",
    "I have been blocked by the seller",
    "The account details of the seller is incorrect"
  ];
  ...
  return (
    <DashboardLayout>
      ...
      <ModalLayout closeModal={() => setModalOpen(false)} isActive={modalOpen}>
        {fundsReceieved ? (
          <TransactionSuccess amount={1200} />
          ...
          <AwaitingConfirmation
            ...
            OnConfirm={OnMakeAppeal}
            setConfirmation={(value) => setFundsReceieved(value)}
            title="Awaiting Payment Confirmation"
            description="Please take a moment while the seller confirms your payment. "
            cancelText="Cancel"
            confirmText="Appeal"
          />
        ) : orderCreated ? (
